            ...
            <div ng-controller = "cartCtrl" ng-init="initCartId('${cartId}')">
                ...
                <table class="table table-striped">
                    ...
                    <tr ng-repeat = "item in cart.cartItems">
                        ...
                        <td><a href="#" class="label label-danger" ng-click="removeFromCart(item.product.productId)"><span class="glyphicon glyphicon-remove-sign"></span>remove</a></td>
                    </tr>
                    <tr>
                        <th></th>
                        <th></th>
                        <th>GrandTotal</th>
                        <th>{{calGrandTotal(cart.cartItems)}}</th>
                        <th></th>
                    </tr>
                    </tbody>
                </table>
